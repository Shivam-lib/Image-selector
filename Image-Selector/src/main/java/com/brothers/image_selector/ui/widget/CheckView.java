package com.brothers.image_selector.ui.widget;
...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        int defaultColor = ResourcesCompat.getColor(
                getResources(), R.color.ImageSelector_item_checkCircle_borderColor,
                getContext().getTheme());
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), R.color.ImageSelector_item_checkCircle_backgroundColor,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
